...
const projects = [
    {
        ...
        description: "A naive bayes algorithm implementation that informs you weather a sentence is about bread or not",
        technologies: ["AI", "Statistical Analysis"],
    ...
    },
    {
        ...
        description: "Web based running tracking application created as part of a group project",
        technologies: ["React.js", "Springboot","MongoDB"],
    ...
    },
    {
        ...
        icon: "/images/maze.jpg",
        description: "Maze generation and solving application that creates 2 and 3 dimensional immersive mazes demonstrating a range of algorithms",
        technologies: ["Unity", "C#", "Search Algorithms"],
